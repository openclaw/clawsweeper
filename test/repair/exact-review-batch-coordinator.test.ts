...
test("queue client reports legacy terminal reconciliation counters", async () => {
    ...
    fetch: async () =>
      new Response(
        JSON.stringify({
          ...
          legacy_state_batch_terminal_candidates: 1,
          legacy_state_batch_terminal_selected: 1,
          legacy_state_batch_terminal_producer_succeeded: 1,
          legacy_state_batch_terminal_eligible: 1,
          legacy_state_batch_terminal_changed: 1,
  ...
  assert.deepEqual(await client.reconcilePublications({ apply: true, maxItems: 100 }), {
    ...
    legacyStateBatchTerminalCandidates: 1,
    legacyStateBatchTerminalSelected: 1,
    legacyStateBatchTerminalProducerSucceeded: 1,
    legacyStateBatchTerminalEligible: 1,
    legacyStateBatchTerminalChanged: 1,

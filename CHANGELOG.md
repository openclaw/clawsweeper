...
- Hardened structural and semantic review reuse against check-state and proof-override drift, stale target snapshots, omitted AST scalar syntax, directive-attachment collisions, tooling-control comment loss, diff-marker ambiguity, missing shard compiler runtimes, and order-sensitive JSON.

...
- Preserve a pending manual review's selected branch when ordinary item events coalesce, while accepting fresh source facts and explicit branch changes from a new manual request.

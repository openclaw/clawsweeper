...
- Redesigned the live dashboard and triage pages with a minimal warm theme that follows the system light/dark preference, a single lobster-coral accent, hairline panels and quiet outline pills, GitHub label colors rendered as neutral dot-pills, and emoji-free metric and section labels.

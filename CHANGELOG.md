...
- Prevented overlapping same-head reviews and stale verdict replay with trusted bounded review leases across label sweeps, routing, and apply, and refused exact-event publication after a failed review.

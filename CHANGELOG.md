...
- Hardened structural and semantic review reuse against check-state, proof-override, and release-lookup drift; omitted AST syntax and tooling controls; diff-marker ambiguity; unsafe runtime staging; unverified, mode-lost, missing, or architecture-mismatched compiler packages; and order-sensitive JSON.

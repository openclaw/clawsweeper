...
- Replaced runner-side exact-review capacity waiting and self-retries with a durable four-slot Worker queue that coalesces item deliveries, leases executors before checkout, and reclaims abandoned leases.

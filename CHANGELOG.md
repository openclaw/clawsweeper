...
- Capped ClawSweeper event hook notifications per run so noisy repair batches do
  not flood the shadow update thread; overflow events remain queued for later
  notifier runs.

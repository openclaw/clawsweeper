...
- Kept contributor repair reviews on one immutable base, revalidated and reviewed a single final synchronized tree, renewed credentials before post-flight publication, and preserved machine-readable repair outcomes when publication fails. Thanks @Takhoffman.

...
- Added immutable, privacy-bounded action ledger shards for all six ClawSweeper action families, with operation, attempt, causal-phase, and retry-stable idempotency correlation.

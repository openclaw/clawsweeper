...
- Prevented scheduled repair-loop label sweeps from dispatching duplicate reviews while a trusted, bounded review-start lease is active for the exact current PR head.

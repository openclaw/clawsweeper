...
| Duplicate-item claim hotfix                  | In progress                                    | Batch admission must select at most one publication event per `targetRepo#itemNumber`, while preserving FIFO order for the deferred event. The hotfix also restores the dashboard claim size and workflow maximum to 4. Re-advance to 8 only after the deduplication regression test, CI, deployment, and a safe live recovery sample pass.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
